...
label_name = Label(main_window, text="Tym AI", fg="#203A43", bg="#36D1DC",
...
def run_tym():
    chat = ChatBot("Tym", database_uri=None)
...
tr.Thread(target=run_tym).start()
...
button_listen = Button(main_window, text="Escuchar", bg='#b6fbff', fg="black",
                       height=2, width=30, font=('Arial', 10, 'bold'), command=tr.Thread(target=run_tym).start())
button_listen.pack(pady=10)
